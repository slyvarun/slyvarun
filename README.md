...
- 🌟 **Google Gemini Campus Ambassador** (2025) - Leading AI initiatives and prompt engineering workshops.
- 🏗️ **Currently Building**: **UniRide**, a specialized ride-sharing ecosystem for student communities.
- 🔍 **Research Interest**: Anomaly Detection in Railway Control Communication Systems.
...
| **AI/ML** | TensorFlow, Scikit-learn, Prompt Engineering, Generative AI |
| **Development** | Full-Stack Web Development, Data Science (Qspiders) |
| **Hardware** | Biomedical Engineering (Ex-Yashoda Hospitals) |
